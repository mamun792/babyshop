                ...
                <div class="post-list mb-4 mb-lg-0">
                        ...
                        <div class="d-md-flex d-block">
                            <div class="post-thumb d-flex mr-15">
                                <a class="color-white" href="blog-post-fullwidth.html">
                                    <img src="{{ asset('ecommerce/assets/imgs/blog/blog-2.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="entry-meta mb-10 mt-10">
                                    <a class="entry-meta meta-2" href="blog-category-fullwidth.html">
                                        <span class="post-in font-x-small">Fashion</span>
                                    </a>
                                </div>
                    ...
                    <article class="wow fadeIn animated">
                        <div class="d-md-flex d-block">
                            <div class="post-thumb d-flex mr-15">
                                <a class="color-white" href="blog-post-fullwidth.html">
                                    <img src="{{ asset('ecommerce/assets/imgs/blog/blog-1.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="entry-meta mb-10 mt-10">
                                    <a class="entry-meta meta-2" href="blog-category-fullwidth.html">
                                        <span class="post-in font-x-small">Healthy</span>
                                    </a>
                                </div>
                                <h4 class="post-title mb-25 text-limit-2-row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="banner-img banner-1 wow fadeIn animated">
                            <img src="{{ asset('ecommerce/assets/imgs/banner/banner-5.jpg') }}" alt="">
                    ...
                    <div class="col-md-6">
                        <div class="banner-img mb-15 wow fadeIn animated">
                            <img src="{{ asset('ecommerce/assets/imgs/banner/banner-6.jpg') }}" alt="">
                            <div class="banner-text">
                                <span>Big Offer</span>
                        ...
                        <div class="banner-img banner-2 wow fadeIn animated mb-0">
                            <img src="{{ asset('ecommerce/assets/imgs/banner/banner-7.jpg') }}" alt="">
                            <div class="banner-text">
